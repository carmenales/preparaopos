...
Este principio no se limita a elaborar un Business Case al comienzo del proyecto: exige que la justificación se mantenga durante todo el proyecto y que las decisiones de continuación se apoyen en información actualizada. El Business Case permite comprobar que el proyecto sigue alineado con los objetivos de la organización y que la inversión continúa estando justificada. Si la justificación deja de ser válida —por ejemplo, porque cambia la normativa aplicable, las prioridades estratégicas, la tecnología disponible, los costes o los riesgos— la organización debe disponer de información suficiente para decidir si modifica el proyecto o deja de continuar con él. Si en cualquier momento del ciclo de vida del desarrollo de software los costes se disparan o los beneficios esperados desaparecen, el Caso de Negocio deja de ser viable y el proyecto debe detenerse.

La versión actualmente vigente del método es **PRINCE2 Project Management (Version 7)**, publicada por PeopleCert, que conserva los **7 principios** del método y reorganiza los antiguos 7 "temas" (*Themes*) de PRINCE2 6 como **7 "prácticas" (*Practices*)**: Business Case, Organización, Calidad, Planes, Riesgo, Cuestiones (*Issues*, que sustituye al antiguo tema "Cambio") y Progreso. El **Business Case** es, por tanto, actualmente una **práctica** de PRINCE2 7, mientras que en la anterior edición (PRINCE2 6) se denominaba **tema**. Los siete procesos del método (incluidos *Starting Up a Project* e *Initiating a Project*) se mantienen en la nueva edición. PRINCE2 7 define además la gestión del Caso de Negocio mediante una **técnica de cuatro pasos**, que conviene memorizar literalmente porque es muy examinable:
...
PRINCE2 7 incorpora además dos focos que resultan especialmente relevantes para el análisis de sistemas de información: la **sostenibilidad** como aspecto del desempeño del proyecto (consumo energético de infraestructuras y centros de datos, ciclo de vida del hardware, obsolescencia tecnológica, gestión de residuos electrónicos e impactos ambientales, sociales y organizativos) y un enfoque explícito sobre **gestión digital y de datos** (calidad, disponibilidad y gobernanza de los datos, integración entre sistemas, arquitectura tecnológica, seguridad de la información y capacidad de evolución de la solución). Ambos elementos pueden condicionar tanto los costes y riesgos del Caso de Negocio como la capacidad real de obtener los beneficios previstos, y deben valorarse cuando resulten pertinentes para el proyecto.

PRINCE2 7 aumenta también la flexibilidad y la capacidad de adaptación (*tailoring*) del método al contexto del proyecto: no exige producir el mismo nivel documental en todos los casos, sino ajustar el nivel de gobierno, documentación, aseguramiento y control a la escala, complejidad, riesgo y necesidades concretas de cada proyecto. Esto es relevante en sistemas de información porque un pequeño desarrollo interno y una plataforma corporativa de alta criticidad no requieren necesariamente el mismo nivel de detalle en su Caso de Negocio.
...
El Caso de Negocio no es únicamente un documento financiero: su finalidad es proporcionar la justificación necesaria para las decisiones de gobierno del proyecto, manteniendo la atención sobre los objetivos de negocio durante todo el ciclo de vida y garantizando responsabilidades claras sobre quién decide qué. En consecuencia, sirve como referencia constante para responder a preguntas como: ¿por qué se realiza el proyecto?, ¿qué valor o beneficios se esperan?, ¿qué inversión requiere?, ¿qué riesgos pueden comprometer la justificación? y ¿continúa siendo conveniente realizar el proyecto?
...
*   **TIR (Tasa Interna de Retorno):** Rentabilidad intrínseca del proyecto; tasa que hace que el VAN de los flujos considerados sea igual a cero.
*   **Payback (Plazo de Recuperación):** Tiempo necesario para recuperar la inversión inicial según el criterio definido.

Estos cuatro indicadores conforman lo que PRINCE2 denomina la sección de **Análisis de Inversión (*Investment Appraisal*)** del Caso de Negocio, que proporciona al Project Board la información necesaria para verificar que el Caso de Negocio justifica la autorización o continuación del proyecto. Un matiz importante para examen: el VAN y el TIR incorporan el valor temporal del dinero (descuentan flujos de caja futuros a valor presente mediante una tasa de descuento), mientras que el ROI simple y el Payback básico no lo hacen, por lo que ofrecen una visión menos precisa en proyectos de larga duración. Cuando se comparan costes y beneficios que se producen en momentos temporales distintos, no resulta adecuado comparar directamente cantidades monetarias de años diferentes: las técnicas de descuento permiten expresar esos costes y beneficios futuros en términos de **valor presente**, aplicando una tasa de descuento cuyo valor concreto depende del marco de evaluación utilizado en cada caso.

En el sector público, la evaluación de un Caso de Negocio no puede reducirse a la rentabilidad financiera privada: debe considerarse el **valor público** y los costes, beneficios y riesgos relevantes para la sociedad, además de la asequibilidad y la viabilidad de ejecución. Por ello, en un proyecto TIC público pueden existir beneficios que no son ingresos monetarios directos, como la reducción de cargas administrativas, la mejora de la accesibilidad y de la calidad del servicio público, la reducción de tiempos de espera, la mejora de la transparencia y la seguridad, la interoperabilidad, el cumplimiento normativo o la mejora de la experiencia de la ciudadanía y de los empleados públicos.

En esta línea, en el ámbito anglosajón la elaboración de casos de negocio del sector público se apoya en el **Five Case Model** de HM Treasury (recogido en el *Green Book*), un marco compuesto por cinco dimensiones complementarias y no intercambiables entre sí:

1.  **Strategic Case (Caso Estratégico):** justificación y objetivos de la intervención y su encaje con la estrategia de la organización.
2.  **Economic Case (Caso Económico):** análisis de una relación de alternativas (longlist/shortlist) para determinar la opción que ofrece mejor relación calidad-precio (*value for money*).
3.  **Commercial Case (Caso Comercial):** viabilidad comercial y forma de obtener los bienes o servicios necesarios (estrategia de contratación, reparto de riesgos).
4.  **Financial Case (Caso Financiero):** asequibilidad de la propuesta para los organismos públicos implicados.
5.  **Management Case (Caso de Gestión):** capacidad y mecanismos para ejecutar, gestionar y evaluar la propuesta.

El Five Case Model es un marco de evaluación propio de la Administración británica, distinto en su estructura documental del Business Case de PRINCE2, aunque ambos comparten la misma finalidad de fondo: demostrar que un proyecto está justificado antes de comprometer recursos públicos. En el marco del Five Case Model, el propio ciclo de maduración del documento avanza por etapas equivalentes al esbozo y detalle del Caso de Negocio de PRINCE2: **Strategic Outline Case (SOC)**, **Outline Business Case (OBC)** y **Full Business Case (FBC)**, correspondiéndose de forma aproximada con el Caso de Negocio Preliminar y el Caso de Negocio Detallado de PRINCE2.
...
Para interpretar correctamente las secciones de Beneficios y Disbeneficios conviene distinguir con precisión cuatro conceptos que se encadenan entre sí: el **producto (output)**, elemento tangible o intangible que el proyecto entrega; el **resultado (outcome)**, el cambio que se produce como consecuencia de utilizar ese producto; el **beneficio (benefit)**, la mejora medible que se obtiene del resultado y que contribuye a los objetivos de la organización; y el **disbeneficio**, la consecuencia medible que resulta negativa para uno o varios interesados. Por ejemplo, en un proyecto de implantación de una plataforma de tramitación electrónica: el producto es la plataforma desplegada y configurada; el resultado es que determinados procedimientos pasan a tramitarse electrónicamente; el beneficio es la reducción del tiempo medio de tramitación y de los costes administrativos; y el disbeneficio es el incremento temporal de la carga de trabajo durante la migración y la formación de los usuarios. Esta distinción es fundamental porque **entregar el producto no garantiza por sí mismo que se hayan obtenido los beneficios**.

Por este motivo, cada beneficio recogido en el Caso de Negocio debe poder comprobarse mediante indicadores adecuados, identificando como mínimo: qué beneficio se pretende conseguir, quién es responsable de su seguimiento, cómo se medirá, cuál es la situación de partida, qué valor objetivo se pretende alcanzar, cuándo se espera que se materialice y qué condiciones deben cumplirse para obtenerlo. En un sistema de información pueden emplearse indicadores como el tiempo medio de tramitación, el número de operaciones procesadas, el porcentaje de trámites realizados electrónicamente, el coste por operación, el número de incidencias, la disponibilidad del servicio, el tiempo de respuesta o el porcentaje de usuarios que utilizan la nueva solución. El indicador debe permitir diferenciar entre haber entregado una solución y haber producido realmente el cambio de negocio que justificaba la inversión.

También conviene no confundir un **riesgo** (acontecimiento incierto que puede afectar al proyecto, positivo o negativo) con un **disbeneficio** (efecto negativo que se espera con certeza razonable como consecuencia del cambio o de la obtención de los resultados). Por ejemplo, que la migración de datos provoque pérdida o corrupción de información es un riesgo; que durante la transición se produzca una reducción temporal de productividad debido a la adaptación de los usuarios es un disbeneficio previsible. Esta diferencia es especialmente relevante en preguntas tipo test que presentan ambos conceptos de forma cruzada.

La sección de **Opciones de Negocio** debe permitir justificar la alternativa seleccionada frente a otras razonables, sin limitarse a comparar precios de adquisición. En un sistema de información deben analizarse, según corresponda, los costes de inversión y recurrentes, los beneficios, los riesgos, los plazos, los impactos organizativos, las dependencias, la seguridad y el cumplimiento normativo, la capacidad de la organización para implantar y operar la solución, y los costes de transición y retirada de la solución existente (**coste del ciclo de vida completo**, que habitualmente supera a la inversión inicial). En un proyecto TIC, el Caso de Negocio debe evitar además que la decisión se base exclusivamente en criterios tecnológicos: una solución técnicamente excelente no está justificada si no responde a una necesidad real, no genera beneficios suficientes, no es sostenible económicamente o no resulta compatible con los objetivos de la organización. Por ello deben considerarse también, entre otros aspectos, la situación actual y el problema a resolver, las necesidades de negocio y de los usuarios, las alternativas tecnológicas y organizativas, los costes de integración y migración, y las dependencias con otros sistemas y proyectos.
...
El Caso de Negocio y el Plan del Proyecto mantienen una relación de **dependencia bidireccional y evolución paralela** a lo largo de todo el ciclo de vida: el Caso de Negocio establece **por qué merece la pena realizar el proyecto**, mientras que el Plan establece **cómo y cuándo se va a realizar el trabajo y con qué recursos**.
...
Durante la ejecución, la información real obtenida del proyecto puede modificar en cualquier momento las previsiones del Caso de Negocio: un aumento de costes puede reducir el valor de la inversión, un retraso puede desplazar la obtención de los beneficios, un riesgo materializado puede aumentar el coste o reducir el alcance de los beneficios, un cambio normativo puede hacer necesaria una solución distinta, y un cambio estratégico puede hacer que una solución inicialmente justificada deje de ser prioritaria. Por ello, el control del proyecto debe permitir detectar en todo momento los cambios que puedan afectar a la justificación de la inversión, cerrando el ciclo de la Justificación Comercial Continua descrito al inicio del tema.

## 7. Terminología PRINCE2 6 frente a PRINCE2 7

Dado que buena parte de la bibliografía y de los materiales de estudio disponibles utiliza todavía terminología de PRINCE2 6, resulta útil tener localizada la correspondencia exacta con la edición vigente:
...
| Mayor orientación documental fija | Mayor flexibilidad y adaptación al contexto (*tailoring*) |
| Sin foco explícito en sostenibilidad | Sostenibilidad como aspecto de desempeño del proyecto |
| Sin foco explícito en datos/digitalización | Enfoque explícito en gestión digital y de datos |

PeopleCert, entidad titular y examinadora del método, ha confirmado que PRINCE2 7 es la versión actual del método y que los exámenes correspondientes a PRINCE2 6 dejaron de estar disponibles para compra desde el **1 de julio de 2024**, fijándose el **31 de diciembre de 2024** como fecha límite para presentarse a dichos exámenes con los vales (vouchers) ya adquiridos con anterioridad. En consecuencia, cualquier certificación PRINCE2 obtenida a partir de esas fechas corresponde ya a la versión 7, lo que resulta relevante para valorar la antigüedad y vigencia de la terminología usada en materiales de estudio o en el temario oficial del proceso selectivo.

Cuando el enunciado de una pregunta no especifique una edición histórica concreta, debe darse prioridad a la terminología vigente de PRINCE2 7 (práctica Business Case). No obstante, si el material oficial del proceso selectivo utiliza terminología de una edición anterior, la correspondencia de la tabla permite traducir directamente entre ambas ediciones sin errores de interpretación.
...
### 8.1. Simulacro de Test: Desmontando trampas
...
### 8.2. Simulacro de Test adicional
...
## 9. Fuentes utilizadas para la ampliación
