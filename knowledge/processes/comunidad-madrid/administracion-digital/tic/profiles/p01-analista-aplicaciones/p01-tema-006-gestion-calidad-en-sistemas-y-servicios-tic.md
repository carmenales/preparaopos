...
La calidad del servicio debe evaluarse mediante objetivos y métricas definidos previamente. Los acuerdos de nivel de servicio pueden establecer objetivos cuantificables para determinados atributos del servicio.

### 1.5. Gestión de la calidad, aseguramiento y control

La **gestión de la calidad** comprende las actividades mediante las que una organización dirige y controla sus procesos respecto de la calidad.
...
La gestión de la calidad incorpora tanto la prevención de problemas como la detección y tratamiento de no conformidades y la mejora continua.
...
La corrección elimina la no conformidad detectada; la acción correctiva actúa sobre la causa de una no conformidad para evitar que vuelva a producirse.
...
Los siete criterios del modelo 2020 son:
...
5. **Impulsar el Rendimiento y la Transformación**.
6. **Percepción de los Grupos de Interés**.
7. **Rendimiento Estratégico y Operativo**.

El modelo EFQM utiliza la lógica **RADAR** como instrumento de evaluación y mejora. La organización determina los resultados que pretende alcanzar, establece los enfoques necesarios, los despliega, evalúa su eficacia y los refina.
...
La lógica RADAR se estructura en:

* **Results (Resultados):** determinar los resultados que se pretenden alcanzar.
* **Approach (Enfoque):** planificar y diseñar los enfoques necesarios para obtener los resultados.
* **Deployment (Despliegue):** implantar los enfoques de forma sistemática.
* **Assessment (Evaluación):** evaluar la eficacia y el desempeño.
* **Refinement (Refinamiento):** introducir mejoras a partir de la evaluación y el aprendizaje.

RADAR constituye una lógica de gestión y evaluación orientada a la mejora continua y no debe confundirse con una simple escala de puntuación.

### 2.5. EFQM y organizaciones públicas
...
## 7. Cuadro Síntesis de conceptos
